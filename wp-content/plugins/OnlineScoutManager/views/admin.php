<div class="wrap">
	...
	<h3>Programme</h3>
	<p>You can display your programme (date, title and summary) on a page.  In any page that you want this to appear, type [programme sectionid=X] where X is your section identifier - see below.</p>
	<?php
